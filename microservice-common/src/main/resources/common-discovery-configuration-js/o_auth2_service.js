...
/** @module common-discovery-configuration-js/o_auth2_service */
...
var JOAuth2Service = io.github.pflima92.plyshare.common.discovery.OAuth2Service;
...
/**
 ...
 @memberof module:common-discovery-configuration-js/o_auth2_service

 @return {OAuth2Service}
 */
OAuth2Service.create = function() {
  var __args = arguments;
  if (__args.length === 0) {
    return utils.convReturnVertxGen(JOAuth2Service["create()"](), OAuth2Service);
