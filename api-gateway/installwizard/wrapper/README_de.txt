...
worden ist, eine Vielzahl von Java bedingten Problem und Einschr?nkungen zu
beheben.

Einige der M?glichkeiten des Wrappers sind:
  * Eine Javaanwendung als Windows Dienst und Unix Daemon zu starten
  * Erh?hung der Zuverl?ssigkeit von Javaanwendungen.
...
Bitte gehen Sie auf unsere Downloadseite f?r mehr Details:
  => http://wrapper.tanukisoftware.com/doc/german/download.jsp

F?r weitere Informationen gehen Sie bitte auf:
...
Bitte besuchen Sie die vollst?ndige Dokumentation auf unserer Webseite.
 ...
 * Javadocs, f?r fortgeschrittene Benutzer
...
Wenn Sie das hier lesen, hei?t das, dass Sie bereits unsere Software entpackt
haben.

Die Standard und Professional Editionen des Java Service Wrappers beinhalten
bereits eine zeitlich beschr?nkte aber vollfunktionst?chtige Triallizenz, die 
es Ihnen erlaubt den Wrapper unbegrenzt oft zu starten und jeweils f?r 15 Minuten
zu laufen. Dies ist f?r einfache, ungezwungene erste Tests gedacht. 


Sie k?nnen ebenfalls kostenlos eine 1monatige Triallizenz beantragen, die wie 
eine Serverlizenz funktioniert und auf einem Server Ihrer Wahl verwendet werden
kann. Triallizenzen k?nnen auf folgender Seite beantragt werden:
  => http://wrapper.tanukisoftware.com/doc/german/requestTrial.jsp


Dauerhafte Lizenzen k?nnen desweiteren auf der folgenden Seite erworben werden:
  => http://wrapper.tanukisoftware.com/doc/german/accountLicenses.jsp


The Community Edition ben?tigt keinerlei Lizenz!

Sollten Sie bereits eine Lizenz erworben haben, k?nnen Sie den Lizenzschl?ssel
...
F?r Entwicklerlizenzen:
  => http://wrapper.tanukisoftware.com/doc/german/accountDevLicenses.jsp

Abh?ngig von der Art der Javaanwendung, bedarf es verschiedene Arten, wie Sie 
...
Der Java Service Wrapper ist verf?gbar unter 3 verschiedenen Lizenzen:

  * Entwicklerlizenz Vereinbarung (Kommerziell)
  * Serverlizenz Vereinbarung (Kommerziell)
  * Communitylizenz Vereinbarung (GPL2)

F?r mehr Informationen besuchen Sie bitte die Lizenz?bersicht auf unserer
Seite:
...
Edition, so k?nnen Sie diese hier online erwerben:
  => http://wrapper.tanukisoftware.com/doc/german/accountLicenses.jsp
...
Sie finden die aktuellste version des Wrappers auf unserer Downloadseite:
  => http://wrapper.tanukisoftware.com/doc/german/download.jsp
F?r die Anleitung gehen Sie bitte auf diese Seite:
...
Eine vollst?ndige Liste der unterst?tzten Plattformen und Systemvoraussetzungen
k?nnen Sie auf der folgenden Seite finden:
