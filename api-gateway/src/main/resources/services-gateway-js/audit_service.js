...
/** @module services-gateway-js/audit_service */
var utils = require('vertx-js/util/utils');

var io = Packages.io;
var JsonObject = io.vertx.core.json.JsonObject;
var JAuditService = io.github.pflima92.plyshare.gateway.services.AuditService;
var Audit = io.github.pflima92.plyshare.gateway.entity.Audit;

/**
 @class
*/
var AuditService = function(j_val) {

  var j_auditService = j_val;
  var that = this;
  ...
  /**
   ...
   @return {AuditService}
   */
  this.save = function(audit, resultHandler) {
    var __args = arguments;
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
