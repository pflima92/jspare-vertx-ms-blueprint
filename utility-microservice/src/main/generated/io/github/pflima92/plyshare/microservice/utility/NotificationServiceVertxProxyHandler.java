...
import io.github.pflima92.plyshare.microservice.utility.NotificationService;
...
public class NotificationServiceVertxProxyHandler extends ProxyHandler {
  ...
  public NotificationServiceVertxProxyHandler(Vertx vertx, NotificationService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public NotificationServiceVertxProxyHandler(Vertx vertx, NotificationService service, long timeoutInSecond) {
